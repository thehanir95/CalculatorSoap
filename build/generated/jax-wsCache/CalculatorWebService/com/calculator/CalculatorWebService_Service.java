 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://calculator.com/", wsdlLocation = "http://localhost:8080/calculatorAppServer/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://calculator.com/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculatorAppServer/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://calculator.com/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.com/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
